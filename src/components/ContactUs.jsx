...
const ContactUs = () => {
  return (
    ...
    <div className="mt-6 ">
            <motion.div className="grid sm:grid-cols-2 items-start gap-14 p-8 mx-auto max-w-5xl   rounded-md font-[sans-serif] "
            ...
            >
                ...
                <form className="ml-auo space-y-4">
                    <input type='text' placeholder='Name'
                        className="bg-transparent w-full text-gray-800 rounded-md py-2.5 px-4 border text-sm outline-blue-500" />
                    <input type='email' placeholder='Email'
                        className="bg-transparent w-full text-gray-800 rounded-md py-2.5 px-4 border text-sm outline-blue-500" />
                    <input type='text' placeholder='Subject'
                        className="bg-transparent w-full text-gray-800 rounded-md py-2.5 px-4 border text-sm outline-blue-500" />
                    <textarea placeholder='Message' rows="6"
                        className="bg-transparent w-full text-gray-800 rounded-md px-4 border text-sm pt-2.5 outline-blue-500"></textarea>
                    <button type='button'
                        className="text-white bg-button_bg hover:bg-blue-600 rounded-md text-sm px-4 py-3 w-full !mt-6">Send</button>
                </form>
            </motion.div>
        </div>
